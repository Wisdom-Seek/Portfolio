...
export default function Intro() {
  return (
     <div id="intro" className="bg-[#0a0b0b] flex items-center justify-between h-[100%] w-ful">
        <div className="flex flex-col w-[30%] ml-[10%]">
           ...
           <a href="/#footer"><button className="bg-[#dc2427] w-40 h-10 hover:bg-[#bd2525] hover:shadow-lg rounded-2xl text-white font-semibold shadow-[#484c51] shadow-md cursor-pointer animate-[pulse_1s_ease-in-out_infinite]">Contact me</button></a> 
        </div>
